/*
	...
	반복문 : 어디서부터 어디까지 반복하나!!!
		...
		4. 반복문 질의(제어) 중지/탈출
			1. break;  :  가장 가까운 반복문을 탈출할 수 있다.
			2. 중간에 i = -1 같이 참을 거짓으로 만드는 코드 추가하기.
...
for( let i = 1 ; i<=10 ; i++ ){
	sum += i // (+=) sum 변수에 i의 값을 더한 값을 sum 변수에 대립
} // for end 
console.log( sum )
/* 예제4 순서도
	...
	for 시작
		...
		i = 2	2<=10 T		sum+=1		1+2=>3		i++
		i = 3	3<=10 T		sum+=1		3+3=>6		i++
		i = 4	4<=10 T		sum+=1		6+4=>10		i++
		i = 5	5<=10 T 	sum+=1		10+5=>15	i++
		i = 6	6<=10 T		sum+=1		15+6=>21	i++
		i = 7	7<=10 T		sum+=1		21+7=>28	i++
		i = 8	8<=10 T		sum+=1		28+8=>36	i++
		i = 9	9<=10 T		sum+=1		36+9=>45	i++
		i = 10	10<=10 T	sum+=1		45+10=>55	i++
		i = 11	11<=10 F 반복문 종료/탈출

*/


// 예제5) i는 1부터 100까지 7배수만 누적 합계
console.log('---------- ex5 ------------- ');
	//1. 7씩 증가하는 방식
sum = 0 ;
